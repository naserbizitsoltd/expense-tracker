...
const DEFAULT_CATEGORIES: DefaultCategorySeed[] = [
  ...
  { name: 'Streaming Services', type: 'expense', icon: 'Tv', color: '#a855f7' },
    // Expense (batch 3)
  { name: 'Laundry & Dry Cleaning', type: 'expense', icon: 'Shirt', color: '#f97316' },
  { name: 'Household Supplies', type: 'expense', icon: 'ShoppingCart', color: '#ef4444' },
  { name: 'Cleaning Service', type: 'expense', icon: 'Sparkles', color: '#ec4899' },
  { name: 'Home Security', type: 'expense', icon: 'ShieldCheck', color: '#a855f7' },
  { name: 'Charity & Donations', type: 'expense', icon: 'HandCoins', color: '#8b5cf6' },
  { name: 'Religious Offerings', type: 'expense', icon: 'Landmark', color: '#6366f1' },
  { name: 'Legal Fees', type: 'expense', icon: 'Scale', color: '#3b82f6' },
  { name: 'Bank Charges', type: 'expense', icon: 'Landmark', color: '#0ea5e9' },
  { name: 'Loan Repayment', type: 'expense', icon: 'HandCoins', color: '#14b8a6' },
  { name: 'Credit Card Bill', type: 'expense', icon: 'CreditCard', color: '#22c55e' },
  { name: 'Interest Paid', type: 'expense', icon: 'Percent', color: '#84cc16' },
  { name: 'Investment Purchase', type: 'expense', icon: 'TrendingUp', color: '#eab308' },
  { name: 'Toll & Highway Fees', type: 'expense', icon: 'Navigation', color: '#f59e0b' },
  { name: 'Vehicle Insurance', type: 'expense', icon: 'ShieldCheck', color: '#64748b' },
  { name: 'Vehicle Registration', type: 'expense', icon: 'FileText', color: '#f97316' },
  { name: 'Car Wash', type: 'expense', icon: 'Droplet', color: '#ef4444' },
  { name: 'Courier & Postage', type: 'expense', icon: 'Truck', color: '#ec4899' },
  { name: 'Printing & Stationery', type: 'expense', icon: 'FileText', color: '#a855f7' },
  { name: 'Office Supplies', type: 'expense', icon: 'Briefcase', color: '#8b5cf6' },
  { name: 'Business Expense', type: 'expense', icon: 'Briefcase', color: '#6366f1' },
  { name: 'Staff Salary', type: 'expense', icon: 'Wallet', color: '#3b82f6' },
  { name: 'Marketing & Ads', type: 'expense', icon: 'LineChart', color: '#0ea5e9' },
  { name: 'Web Hosting & Domains', type: 'expense', icon: 'Cloud', color: '#14b8a6' },
  { name: 'Cloud Storage', type: 'expense', icon: 'Cloud', color: '#22c55e' },
  { name: 'Music & Audio', type: 'expense', icon: 'Headphones', color: '#84cc16' },
  { name: 'Sports & Recreation', type: 'expense', icon: 'Dumbbell', color: '#eab308' },
  { name: 'Baby Supplies', type: 'expense', icon: 'Baby', color: '#f59e0b' },
  { name: 'Elder Care', type: 'expense', icon: 'Users', color: '#64748b' },
  { name: 'Eye Care & Glasses', type: 'expense', icon: 'Stethoscope', color: '#f97316' },
  { name: 'Lab Tests', type: 'expense', icon: 'Syringe', color: '#ef4444' },
  // Income
  ...
  { name: 'Other Income Source', type: 'income', icon: 'MoreHorizontal', color: '#eab308' },
    // Income (batch 3)
  { name: 'Second Salary', type: 'income', icon: 'Wallet', color: '#f97316' },
  { name: 'Contract Work', type: 'income', icon: 'Briefcase', color: '#ef4444' },
  { name: 'Performance Incentive', type: 'income', icon: 'Star', color: '#ec4899' },
  { name: 'Festival Bonus', type: 'income', icon: 'Gift', color: '#a855f7' },
  { name: 'Arrear Payment', type: 'income', icon: 'Banknote', color: '#8b5cf6' },
  { name: 'Leave Encashment', type: 'income', icon: 'Wallet', color: '#6366f1' },
  { name: 'Gratuity', type: 'income', icon: 'PiggyBank', color: '#3b82f6' },
  { name: 'Severance Pay', type: 'income', icon: 'Banknote', color: '#0ea5e9' },
  { name: 'Profit Share', type: 'income', icon: 'LineChart', color: '#14b8a6' },
  { name: 'Partnership Income', type: 'income', icon: 'Users', color: '#22c55e' },
  { name: 'FDR Interest', type: 'income', icon: 'Landmark', color: '#84cc16' },
  { name: 'DPS Interest', type: 'income', icon: 'PiggyBank', color: '#eab308' },
  { name: 'Savings Interest', type: 'income', icon: 'Percent', color: '#f59e0b' },
  { name: 'Bond Interest', type: 'income', icon: 'FileText', color: '#64748b' },
  { name: 'Mutual Fund Return', type: 'income', icon: 'TrendingUp', color: '#f97316' },
  { name: 'Stock Sale', type: 'income', icon: 'LineChart', color: '#ef4444' },
  { name: 'Crypto Sale', type: 'income', icon: 'Coins', color: '#ec4899' },
  { name: 'Foreign Remittance', type: 'income', icon: 'Globe', color: '#a855f7' },
  { name: 'Currency Exchange Gain', type: 'income', icon: 'Coins', color: '#8b5cf6' },
  { name: 'Subletting Income', type: 'income', icon: 'Building2', color: '#6366f1' },
  { name: 'Vehicle Rental Income', type: 'income', icon: 'Car', color: '#3b82f6' },
  { name: 'Equipment Rental', type: 'income', icon: 'Wrench', color: '#0ea5e9' },
  { name: 'Tutoring Income', type: 'income', icon: 'GraduationCap', color: '#14b8a6' },
  { name: 'Training & Workshop Fee', type: 'income', icon: 'School', color: '#22c55e' },
  { name: 'Speaking Fee', type: 'income', icon: 'Users', color: '#84cc16' },
  { name: 'Content Creation', type: 'income', icon: 'Camera', color: '#eab308' },
  { name: 'Sponsorship', type: 'income', icon: 'Star', color: '#f59e0b' },
  { name: 'Donation Received', type: 'income', icon: 'HandCoins', color: '#64748b' },
  { name: 'Refund from Vendor', type: 'income', icon: 'RotateCcw', color: '#f97316' },
  { name: 'Warranty Claim', type: 'income', icon: 'ShieldCheck', color: '#ef4444' },
]
