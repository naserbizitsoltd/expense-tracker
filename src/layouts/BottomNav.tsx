...
export function BottomNav({ active, onChange }: BottomNavProps) {
  return (
    <nav
      className="safe-bottom fixed inset-x-0 bottom-0 z-40 border-t border-border/70 bg-background/90 backdrop-blur-lg"
      aria-label="Primary"
    >
          ...
          return (
            ...
            >
              <span className="relative flex h-8 w-11 items-center justify-center">
                ...
                <Icon
                  className={cn('relative z-[1] h-[19px] w-[19px]', isActive ? 'text-primary' : 'text-muted-foreground')}
